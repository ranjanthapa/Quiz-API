...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='New Quiz', max_length=225, verbose_name='New Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficult', models.IntegerField(choices=[(0, 'Fundamental'), (1, 'Beginner'), (2, 'Intermediate'), (3, 'Advance'), (4, 'Advance')], default=0, verbose_name='Difficulty')),
